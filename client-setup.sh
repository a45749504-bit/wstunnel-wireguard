...
if [ "$ARCH" = "aarch64" ]; then
    WSTUNNEL_URL="https://github.com/erebe/wstunnel/releases/download/v10.6.2/wstunnel_10.6.2_linux_arm64.tar.gz"
    WSTUNNEL_FILE="wstunnel.tar.gz"
    EXTRACT_DIR="wstunnel_10.6.2_linux_arm64"
elif [ "$ARCH" = "x86_64" ]; then
    WSTUNNEL_URL="https://github.com/erebe/wstunnel/releases/download/v10.6.2/wstunnel_10.6.2_linux_amd64.tar.gz"
    WSTUNNEL_FILE="wstunnel.tar.gz"
    EXTRACT_DIR="wstunnel_10.6.2_linux_amd64"
else
...
tar -xzf "$WSTUNNEL_FILE"
cp "${EXTRACT_DIR}/wstunnel" ./wstunnel
chmod +x wstunnel
rm -rf "$WSTUNNEL_FILE" "$EXTRACT_DIR"
